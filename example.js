var app = angular.module('plunker', ['ui.bootstrap','infinite-scroll']);

app.directive('fixedHeaderfooter',['$timeout','$compile','$window','$document',function($timeout,$compile,$window,$document){
  return{
    link:link,
...
function ListCtrl($scope,$position) {
